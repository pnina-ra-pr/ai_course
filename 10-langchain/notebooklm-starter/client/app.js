...
// Generating is slow (a full agent turn), so the button reports its own progress and the
// finished artifact opens in the viewer — it is also saved as a note.
async function generateArtifact(a, btn) {
  const title = btn.querySelector(".a-title");
